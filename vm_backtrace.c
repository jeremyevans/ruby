...
static VALUE
ec_backtrace_object(const rb_execution_context_t *ec, bool skip_internal)
{
...
{
    return ec_backtrace_object(ec, FALSE);
}
...
{
    return backtrace_to_location_ary(ec_backtrace_object(ec, skip_internal), lev, n);
}
...
rb_debug_inspector_open(rb_debug_inspector_func_t func, void *data)
{
    ...
    dbg_context.backtrace = rb_ec_backtrace_location_ary(ec, 0, 0, FALSE);
